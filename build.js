...
(function($opal) {
  ...
  alert("opal version is:"+((($a = $scope.RUBY_ENGINE_VERSION) == null ? $opal.cm('RUBY_ENGINE_VERSION') : $a)));
;
  return (function($base, $super) {
    function $Foo(){};
    ...
    return (def.$bar = function() {
      var self = this;

      return "called bar on class Foo defined in ruby code";
    }, nil)
  })(self, null);
})(Opal);
